"""Global configuration values for the Mission Center clone."""
...
APP_NAME = "Mission Center Clone"
APP_ID = "com.example.mission_center_clone"
DATA_DIR = Path.home() / ".mission_center_clone"
